...
double ModelSolver02::gauss15(std::function<double(double)> f, double a, double b) {
...
double ModelSolver02::adaptiveGauss(std::function<double(double)> f, double a, double b, double eps, int depth, int maxDepth) {
    double c = (a + b) / 2.0;
